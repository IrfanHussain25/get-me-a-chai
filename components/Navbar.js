...
const Navbar = () => {
  ...
  return (
    <nav className='bg-gray-900 shadow-xl shadow-white text-white flex flex-col md:flex-row justify-between items-center px-4 md:h-16'>
      ...
      <div className='relative flex justify-center items-center flex-col md:block gap-4 pb-2 md:pb-0'>
        {session && <>
